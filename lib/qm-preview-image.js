...
const aitSpin = "_ait-spin_xui1z_1";
const aitSpinDot = "_ait-spin-dot_xui1z_7";
const dotAnimation = "_dotAnimation_xui1z_1";
const aitSpinDotItem = "_ait-spin-dot-item_xui1z_16";
const dotItemAnimation = "_dotItemAnimation_xui1z_1";
const aitSpinBox = "_ait-spin-box_xui1z_46";
const aitSpinSpinning = "_ait-spin-spinning_xui1z_51";
const hide = "_hide_xui1z_61";
const aitSpinSpinningCenter = "_ait-spin-spinning-center_xui1z_65";
const aitSpinContainer = "_ait-spin-container_xui1z_71";
const aitSpinMask = "_ait-spin-mask_xui1z_75";
const styles = {
  aitSpin,
  aitSpinDot,
  dotAnimation,
