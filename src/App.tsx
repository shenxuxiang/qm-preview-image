...
function App() {
  ...
  return (
    <div>
      <div style={{ width: 120, height: 32, border: '1px solid #ddd' }} onClick={() => setOpen(true)}>hello world</div>

      <PreviewImage index={0} open={open} imgs={imgs} onClose={() => setOpen(false)} previewImgs={imgs} hasPerformance/>
    </div>
  );
}
