...
import require$$0, { PureComponent, memo, useState, useRef, useEffect, useCallback, forwardRef, useImperativeHandle } from "react";
...
const head = "_head_eto08_1";
const operationIcon = "_operation-icon_eto08_13";
const rotate90 = "_rotate90_eto08_26";
const body = "_body_eto08_29";
const button = "_button_eto08_34";
const buttonHover = "_button-hover_eto08_50";
const prevButton = "_prev-button_eto08_55";
const disabled = "_disabled_eto08_78";
const nextButton = "_next-button_eto08_83";
const bodyContent = "_bodyContent_eto08_111";
const previewImg = "_preview-img_eto08_118";
const foot = "_foot_eto08_124";
const footButton = "_foot-button_eto08_134";
const footPrevButton = "_foot-prev-button_eto08_147";
const footNextButton = "_foot-next-button_eto08_171";
const footSlider = "_foot-slider_eto08_195";
const footSliderList = "_foot-slider-list_eto08_203";
const footSliderListItem = "_foot-slider-list-item_eto08_211";
const active = "_active_eto08_233";
const classes$1 = {
  head,
  operationIcon,
  rotate90,
...
function PreviewImage(props) {
  const { onClose, open: open2, imgs, previewImgs = imgs, index: index2 = 0, hasPerformance } = props;
  ...
  useEffect(() => {
    function handleResize() {
      ...
      if (totalRef.current <= pageSizeRef.current)
        setState({ isEndPage: true, isStartPage: true });
    }
    if (open2) {
      handleResize();
  ...
  }, [open2, imgs, previewImgs]);
  useEffect(() => {
    if (open2) {
      let currentIndex2 = index2;
      if (index2 <= 0) {
        currentIndex2 = 0;
      } else if (index2 >= totalRef.current) {
        currentIndex2 = totalRef.current - 1;
      }
      sliderAnimation(currentIndex2, 0);
      setState({
        currentIndex: currentIndex2,
        isStartPage: currentIndex2 < Math.ceil(pageSizeRef.current / 2) || totalRef.current <= pageSizeRef.current,
        isEndPage: currentIndex2 > totalRef.current - 1 - Math.ceil(pageSizeRef.current / 2) || totalRef.current <= pageSizeRef.current
      });
    }
  }, [open2, index2]);
  useEffect(() => {
    ...
    img.onload = () => {
      if (imgRef.current)
        imgRef.current.src = largeImageUrl;
    };
    return () => {
      img.onload = null;
    };
  ...
  const sliderAnimation = (index22, duration = 300) => {
    ...
    if (index22 + 1 <= halfMaxSize) {
      offsetX = 0;
    } else if (index22 + 1 > totalRef.current - halfMaxSize) {
  ...
  const handleNextItem = () => {
    if (currentIndex >= totalRef.current - 1)
      return;
    imgRef.current.style.transform = `scale(1, 1) rotateZ(0deg)`;
    setState((prev) => {
      let count = prev.currentIndex + 1;
  ...
  const handleChangeIndex = (index22) => {
    ...
    setState({
      ...
      isStartPage: index22 < Math.ceil(pageSizeRef.current / 2) || totalRef.current <= pageSizeRef.current,
      isEndPage: index22 > totalRef.current - 1 - Math.ceil(pageSizeRef.current / 2) || totalRef.current <= pageSizeRef.current
    });
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Modal$1, { open: open2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { width: "100%", height: "100%" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes$1.head, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-swap-outline ${classes$1.operationIcon} ${classes$1.rotate90}`, onClick: handleMirrorY }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-swap-outline ${classes$1.operationIcon}`, onClick: handleMirrorX }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-rotate-left ${classes$1.operationIcon}`, onClick: handleRotateLeft }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-rotate-right ${classes$1.operationIcon}`, onClick: handleRotateRight }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-minus-circle ${classes$1.operationIcon}`, onClick: handleScaleMinus }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-plus-circle ${classes$1.operationIcon}`, onClick: handleScalePlus }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: `qm-iconfont qm-icon-close ${classes$1.operationIcon}`, onClick: onClose })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes$1.body, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          onClick: handlePrevItem,
          className: `${classes$1.prevButton}${currentIndex === 0 ? " " + classes$1.disabled : ""}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "qm-iconfont qm-icon-arrow-left-bold", style: { fontSize: 60 } })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes$1.bodyContent, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          ref: imgRef,
          alt: "预览图片",
          src: previewImgs[currentIndex],
          className: classes$1.previewImg,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          className: `${classes$1.nextButton}${currentIndex >= totalRef.current - 1 ? " " + classes$1.disabled : ""}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "qm-iconfont qm-icon-arrow-right-bold", style: { fontSize: 60 } })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes$1.foot, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${classes$1.footPrevButton}${isStartPage ? " " + classes$1.disabled : ""}`, onClick: handlePrevPage, children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "qm-iconfont qm-icon-arrow-left-bold", style: { fontSize: 30 } }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          onClick: handleNextPage,
          className: `${classes$1.footNextButton}${isEndPage ? " " + classes$1.disabled : ""}`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("i", { className: "qm-iconfont qm-icon-arrow-right-bold", style: { fontSize: 30 } })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes$1.footSlider, ref: sliderWrapperRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: classes$1.footSliderList, ref: sliderRef, children: previewImgs.map(
        (url, index22) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "li",
          {
            onClick: () => handleChangeIndex(index22),
            className: `${classes$1.footSliderListItem}${currentIndex === index22 ? " " + classes$1.active : ""}`,
